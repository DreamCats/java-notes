...
- **常见问题**
    - [Redis是什么?](/Interview/redis/Redis-面试常见的问题.md#redis是什么玩意)
    - [为什么要用Redis/为什么要用缓存？](/Interview/redis/Redis-面试常见的问题.md#为什么要用redis为什么要用缓存)
    - [使用Redis有哪些好处？](/Interview/redis/Redis-面试常见的问题.md#使用redis有哪些好处)
    - [为什么要用Redis而不用map/guava做缓存?](/Interview/redis/Redis-面试常见的问题.md#为什么要用-redis-而不用-mapguava-做缓存)
    - [Redis相比Memcached有哪些优势？](/Interview/redis/Redis-面试常见的问题.md#redis相比memcached有哪些优势)
    - [Redis的线程模型？](/Interview/redis/Redis-面试常见的问题.md#redis的线程模型)
    - [Redis常见性能问题和解决方案](/Interview/redis/Redis-面试常见的问题.md#redis常见性能问题和解决方案)
    - [Redis常见数据结构以及使用场景分析](/Interview/redis/Redis-面试常见的问题.md#redis-常见数据结构以及使用场景分析)
    - [Redis设置过期时间](/Interview/redis/Redis-面试常见的问题.md#redis-设置过期时间)
    - [MySQL里有2000w数据，redis中只存20w的数据，如何保证redis中的数据都是热点数据](/Interview/redis/Redis-面试常见的问题.md#mysql里有2000w数据redis中只存20w的数据如何保证redis中的数据都是热点数据)
    - [Memcache与Redis的区别都有哪些？](/Interview/redis/Redis-面试常见的问题.md#memcache与redis的区别都有哪些)
    - [Redis持久化机制（怎么保证Redis挂掉之后再重启数据可以进行恢复）](/Interview/redis/Redis-面试常见的问题.md#redis-持久化机制怎么保证-redis-挂掉之后再重启数据可以-进行恢复)
    - [AOF重写](/Interview/redis/Redis-面试常见的问题.md#aof-重写)
    - [Redis事务](/Interview/redis/Redis-面试常见的问题.md#redis-事务)
    - [Redis常见的性能问题都有哪些？如何解决？](/Interview/redis/Redis-面试常见的问题.md#redis-常见的性能问题都有哪些如何解决)
    - [Redis的同步机制了解么？](/Interview/redis/Redis-面试常见的问题.md#redis的同步机制了解么)
    - [是否使用过Redis集群，集群的原理是什么？](/Interview/redis/Redis-面试常见的问题.md#是否使用过redis集群集群的原理是什么)
    - [缓存雪崩和缓存穿透问题解决方案](/Interview/redis/Redis-面试常见的问题.md#缓存雪崩和缓存穿透问题解决方案)
    - [如何解决Redis的并发竞争Key问题](/Interview/redis/Redis-面试常见的问题.md#如何解决-redis-的并发竞争-key-问题)
    - [如何保证缓存与数据库双写时的数据一致性？](/Interview/redis/Redis-面试常见的问题.md#如何保证缓存与数据库双写时的数据一致性)
